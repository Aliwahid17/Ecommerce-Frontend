    ...
    return (
        <>
            <nav className='sticky top-0'>
                <div className="bg-gray-600 font-sans w-full m-0 ">
                    <div className="bg-white  shadow-md ">
                        <div className="container mx-auto px-3 md:px-12 lg:px-24 ">
                            <div className="flex items-center justify-between py-4">
                                ...
                                <Link href="/">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-[#20f020]" viewBox="0 0 24 24">
                                ...
                                <div className="flex ">
                                    ...
                                    {/* <div className='flex' >
                                        <input type="search" placeholder="Search" className="bg-black" />
                                        <button className="w-10 h-10 flex items-center justify-center ">
                                            <Image width={33.35} height={33.35} src={Search} alt='Search' />
                                        </button>
                                    </div> */}

                                    <div className=" flex mr-1 md:mr-4 h-10 text-gray-600 border-2 rounded-lg border-gray-300 bg-white focus-within:border-green-500 ">
                                    ...
                                    {/* <div className="inline-flex relative text-gray-600">
                                    <input type="search" name="serch" placeholder="Search" className="bg-grey-300 border-2 border-green-700  rounded-2xl text-sm focus:outline-none"/> */}
                                    {/* <button className="w-10 h-10 flex items-center justify-center"> */}
                                    {/* <div className="inline-flex">
                                        <input type={'search'} placeholder="Search..." className="bg-gray-800 w-10" /> */}
                                    ...
                                    {/* <input className="ml-2 outline-none  font-sm bg-black" type="text" name="search" id="search" placeholder="Search..." /> */}
                                    ...
                                    <button className="w-10 lg:w-28 h-10 md:mr-3 flex items-center justify-center lg:justify-evenly ">
                                        <Image width={33.35} height={33.35} src={Support} alt='Support' />
                                        <div className="hidden lg:block">Support</div>
                                    </button>

                                    {/* User  */}

                                    {/* <button className="w-10 h-10 flex items-center justify-center mr-[1px] "> */}
                                    <button className="w-10 lg:w-28 h-10 flex items-center justify-center lg:justify-evenly mr-[-7px] md:mr-[5px]">
                                    ...
                                    <button className="w-10 lg:w-20 h-10 lg:mr-0 flex items-center justify-center lg:justify-around">
                                        <Image width={33.35} height={33.35} src={Cart} alt='Cart' />
